      ...
      dashboard = {
        preset = {
          ...
          keys = {
            ...
            { icon = "󰚩 ", key = "a", desc = "New Claude session", action = ":MautNew" },
            { icon = "󱖫 ", key = "A", desc = "Resume Claude session", action = ":MautResume" },
            { icon = "󰚩 ", key = "C", desc = "Claude Sessions (review changes)", action = ":MautSessions" },
            { icon = " ", key = "t", desc = "Terminal", action = function() Snacks.terminal() end },
